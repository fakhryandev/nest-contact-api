...
describe('AddressController', () => {
  ...
  describe('GET /api/contacts/:contactId/addresss/:addressId', () => {
    beforeEach(async () => {
      await testService.deleteAddress();
      await testService.deleteContact();
      await testService.deleteUser();
  ...
  describe('PUT /api/contacts/:contactId/addresses/:addressId', () => {
    ...
    it('should be able to update address', async () => {
      ...
      expect(response.body.data.postal_code).toBe('6666');
    });
  });

  describe('DELETE /api/contacts/:contactId/addresss/:addressId', () => {
    beforeEach(async () => {
      await testService.deleteAddress();
      await testService.deleteContact();
      await testService.deleteUser();
  ...
  describe('GET /api/contacts/:contactId/addresss/', () => {
    beforeEach(async () => {
      await testService.deleteAddress();
      await testService.deleteContact();
      await testService.deleteUser();
